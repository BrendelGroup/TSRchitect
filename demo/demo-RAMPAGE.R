...
# ... finding TSRs for all data sets:
determineTSR(experimentName=riceRAMPAGE, parallel=FALSE, tsrSetType="replicates", tssSet="all", tagCountThreshold=3, clustDist=20, writeTable=TRUE)
...
determineTSR(experimentName=riceRAMPAGE, parallel=FALSE, tsrSetType="merged", tssSet="all", tagCountThreshold=3, clustDist=20, writeTable=TRUE)
