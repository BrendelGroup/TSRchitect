...
determineTSR(experimentName=riceRAMPAGE, parallel=TRUE, tsrSetType="replicates", tssSet="all", tagCountThreshold=3, clustDist=20, writeTable = TRUE)
...
determineTSR(experimentName=riceRAMPAGE, parallel=TRUE, tsrSetType="merged", tssSet="all", tagCountThreshold=3, clustDist=20, writeTable = TRUE)

# ... now adding tag count output:
#
addTagCountsToTSR(experimentName=riceRAMPAGE, tsrSetType="merged", tsrSet=3, tagCountThreshold=3, writeTable=TRUE)
