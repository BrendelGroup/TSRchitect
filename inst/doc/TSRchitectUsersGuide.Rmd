...
expDir="HsRAMPAGEbam/", isPairedEnd=TRUE) 
ls()
```
...
```{r eval=FALSE}
setSampleID(experimentName=Hs_RAMPAGE, /
sample.names=c("H460-rep1", "H460-rep2", /
"HT1080-rep1","HT1080-rep2"), replicate.IDs /
=c(1,1,2,2))
```
...
determineTSR(experimentName=Hs_RAMPAGE, parallel=TRUE, /
tsrSetType="merged", tssSet="all", tagCountThreshold=40,/
