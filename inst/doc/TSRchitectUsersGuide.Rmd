...
```{r eval=FALSE}
Hs_RAMPAGE <- loadTSSobj(expTitle ="Human RAMPAGE", inputDirBAM="HsRAMPAGEbam/", /
...
```{r eval=FALSE}
At_PEAT <- loadTSSobj(expTitle ="Arabidopsis PEAT dataset", inputDirBAM="PEATbam", /
...
CAGEhuman <- loadTSSobj(expTitle ="Human CAGE", inputDirBAM="HsCAGEbam", /
