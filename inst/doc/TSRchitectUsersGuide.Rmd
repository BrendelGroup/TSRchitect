...
```{r eval=FALSE}
processTSS(experimentName=Hs_RAMPAGE, parallel=TRUE, n.cores = 4, tssSet="all", /
writeTable=TRUE)
```
...
```{r eval=FALSE}
determineTSR(experimentName = Hs_RAMPAGE, parallel = TRUE, n.cores = 4, /
...
determineTSR(experimentName=Hs_RAMPAGE, parallel=TRUE, n.cores = 4, /
tsrSetType="merged", tssSet="all", tagCountThreshold=40, clustDist=20, /
writeTable=TRUE)
```
...
```{r eval=FALSE}
importAnnotationHub(experimentName = Hs_RAMPAGE, provider = "gencode", annotType = "gff3", species = "human", /
ID = "AH49555")
```
...
```{r eval=FALSE}
processTSS(experimentName=At_PEAT, parallel=FALSE, n.cores=1, tssSet="all", /
writeTable=TRUE)

determineTSR(experimentName=At_PEAT, parallel=FALSE, n.cores=1, tsrSetType="replicates", /
...
processTSS(experimentName=CAGEhuman, parallel=TRUE, n.cores = 4, tssSet="all", /
writeTable=TRUE)
```
```{r eval=FALSE}
#Finding TSRs for the replicate datasets:
determineTSR(experimentName=CAGEhuman, parallel=TRUE, n.cores = 4, /
