...
To check this on the tssObject [S4 object](http://adv-r.had.co.nz/S4.html) you have created, simply check the list of .bam files as follows:
...
```{r eval=FALSE}
setSampleID(experimentName=Hs_RAMPAGE, sample.names=c("H460-rep1", "H460-rep2","HT1080-rep1","HT1080-rep2"), /
...
determineTSR(experimentName=Hs_RAMPAGE, parallel=TRUE, tsrSetType="merged", tssSet="all", /
tagCountThreshold=40, clustDist=20, writeTable=TRUE)
```
...
```{r eval=FALSE}
addTagCountsToTSR(experimentName=Hs_RAMPAGE, tsrSetType="merged", tsrSet=3, /
...
```{r eval=FALSE}
importAnnotation(experimentName = Hs_RAMPAGE, fileType = "gff3", /
annotFile = "downloads/gencode.v19.annotation.gff3")
```
...
```{r eval=FALSE}
addAnnotationToTSR(experimentName=Hs_RAMPAGE, tsrSetType="merged", tsrSet=1, upstreamDist=1000, /
downstreamDist=200, feature="transcript", featureColumnID="ID", writeTable=TRUE)
addAnnotationToTSR(experimentName=Hs_RAMPAGE, tsrSetType="merged", tsrSet=2, upstreamDist=1000, /
downstreamDist=200, feature="transcript", featureColumnID="ID", writeTable=TRUE)
```
...
```{r eval=FALSE}
addAnnotationToTSR(experimentName = Hs_RAMPAGE, tsrSetType="merged", tsrSet=3, upstreamDist=1000, /
downstreamDist=200, feature="transcript", featureColumnID="ID", writeTable=TRUE)
```
...
expDir="PEATbam/", isPairedEnd=TRUE)
...
```{r eval=FALSE}
importAnnotation(experimentName=At_PEAT, fileType="gff3", /
...
```{r eval=FALSE}
importAnnotation(experimentName=CAGEhuman, fileType="gff3", /
annotFile="downloads/gencode.v19.annotation.gff3")
```
