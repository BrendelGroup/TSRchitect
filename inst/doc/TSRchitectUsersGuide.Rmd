...
Similarly, we could use the same code framework above to plot the distributions of TSR width, nTAGs, mSI and torque; to do this we would select the appropriate column. For example: equivalent plots can generated for mSI simply by changing the term "tsrSI" with "tsrMSI" in the two code snippets below.
