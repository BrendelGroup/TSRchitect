...
vignette: >
  %\VignetteIndexEntry{TSRchitect UsersGuide}
...
```{r eval=FALSE}
importAnnotation(experimentName = Hs_RAMPAGE, fileType = "gff3", annotFile = "downloads/gencode.v19.annotation.gff3")
```
...
```{r eval=FALSE}
importAnnotation(experimentName=At_PEAT, fileType="gff3", annotFile="downloads/TAIR10_GFF3_genes.gff")
...
```{r eval=FALSE}
importAnnotation(experimentName=CAGEhuman, fileType="gff3", annotFile="downloads/gencode.v19.annotation.gff3")
```
