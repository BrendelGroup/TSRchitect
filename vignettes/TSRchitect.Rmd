...
```{r eval=TRUE}
initializeExp(expTitle = "Vignette Example",
experimentName= "tssObjectExample",
isPairedEnd=TRUE)

extdata.dir <- system.file("extdata", package="TSRchitect") 

importBam(experimentName=tssObjectExample, extdata.dir)

setSampleID(experimentName=tssObjectExample, sample.names=c("sample1-rep1",
"sample1-rep2","sample2-rep1","sample2-rep2"), replicate.IDs=c(1,1,2,2))
#datasets 1-2 and 3-4 are replicates
```
...
processTSS(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tssSet="all", writeTable=FALSE)
```

Now that this is complete  we can we proceed with identifing TSRs from TSSs.
We do this for each of the 4 datasets we imported.

```{r eval=TRUE}
determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", tssSet="1",

tagCountThreshold=25, clustDist=20,
writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", tssSet="2",
tagCountThreshold=25, clustDist=20, writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", tssSet="3",
tagCountThreshold=25, clustDist=20, writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", tssSet="4", tagCountThreshold=25, clustDist=20, 
writeTable=FALSE)
```
...
determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="merged",
tssSet="all", tagCountThreshold=25, clustDist=20, writeTable=FALSE)

addTagCountsToTSR(experimentName=tssObjectExample, tsrSetType="merged", tsrSet=1,
...
annotFile="gencode.v19.chr22.transcript.gff3")

addAnnotationToTSR(experimentName=tssObjectExample, tsrSetType="merged", tsrSet=1,
