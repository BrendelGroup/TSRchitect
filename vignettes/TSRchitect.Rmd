...
First, we will install ENCODExplorer directly from github using devtools.
...
For our second example will process TSS profiling data from Arabidopsis root tissue. This data comes from the Megraw Lab of Oregon State University and was reported in Morton et al., 2014. [link](10.1105/tpc.114.125617)
