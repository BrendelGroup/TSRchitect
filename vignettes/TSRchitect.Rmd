...
```{r eval=TRUE}
initializeExp(expTitle = "Vignette Example", experimentName= "tssObjectExample", 
isPairedEnd=TRUE)
...
```{r eval=TRUE}
determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", 
tssSet="1", tagCountThreshold=25, clustDist=20, writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", 
tssSet="2", tagCountThreshold=25, clustDist=20, writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", 
tssSet="3", tagCountThreshold=25, clustDist=20, writeTable=FALSE)

determineTSR(experimentName=tssObjectExample, parallel=FALSE, n.cores=1, tsrSetType="replicates", 
tssSet="4", tagCountThreshold=25, clustDist=20, writeTable=FALSE)
```
