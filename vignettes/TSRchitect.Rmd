...
processTSS(experimentName=tssObjectExample, n.cores=1, tssSet="all", writeTable=FALSE)
```
...
```{r eval=TRUE}
determineTSR(experimentName=tssObjectExample, n.cores=1, tsrSetType="replicates", 
...
determineTSR(experimentName=tssObjectExample, n.cores=1, tsrSetType="merged", 
