...
## Example 1: Identifying promoters from RAMPAGE data derived from human fibrosarcoma vs normal lung tissue.
...
For our first example, we will process RAMPAGE data from human lung cell lines with TSRchitect.
