...
HT1080:
-[HT1080-rep1](https://www.encodeproject.org/files/ENCFF474YPI/@@download/ENCFF474YPI.bam)
-[HT1080-rep2](https://www.encodeproject.org/files/ENCFF242UWH/@@download/ENCFF242UWH.bam)
...
Please download these to your machine and and rename them according to their labels above. For example, the file ENCFF474YPI.bam should be given the name HT1080-rep1.bam, and so on. Once this is complete, please move the files into a new folder called ```bam_files/``` inside the vignettes/ folder.
