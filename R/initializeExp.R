...
#' @param experimentName name for the \emph{tssObject} to be created
#' (character).
#' Your choice for \emph{experimentName} must lack spaces.
#' @param expDir path to the directory with the alignment files in .bam
#' format (character).
...
#'
#' @note Please note that all .bam files found in \emph{expDir} will be
...
setMethod("initializeExp",
          signature(expTitle="character", experimentName="character",
                    expDir="character", isPairedEnd="logical"),
