...
setGeneric(
           name="detTSR",
           def=function(experimentName, tsrSetType, tssSet=1, tagCountThreshold, clustDist) {
               standardGeneric("detTSR")
    }
    )

setMethod("detTSR",
          signature(experimentName="tssObject", "character", "numeric", "numeric", "numeric"),

          function(experimentName, tsrSetType, tssSet, tagCountThreshold=1, clustDist) {
             ...
             if (tsrSetType=="replicates") {
                 ...
                 stop("Error: argument tsrSetType to detTSR() should be either \"replicates\" or \"merged\".")
             }
